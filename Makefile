srcdir = /home/hnakamur/php-ext-decnum
builddir = /home/hnakamur/php-ext-decnum
top_srcdir = /home/hnakamur/php-ext-decnum
top_builddir = /home/hnakamur/php-ext-decnum
EGREP = grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--enable-decnum'
CONFIGURE_OPTIONS = '--enable-decnum'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = gawk
shared_objects_decnum = decnum.lo libdecNumber/decNumber.lo libdecNumber/decContext.lo
PHP_PECL_EXTENSION = decnum
PHP_MODULES = $(phplibdir)/decnum.la
PHP_ZEND_EX =
...
prefix = /usr/local
phplibdir = /home/hnakamur/php-ext-decnum/modules
